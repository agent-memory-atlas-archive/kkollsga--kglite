...
pub(crate) const FUNCTIONS: &[FunctionSpec] = &[
    ...
    FunctionSpec {
        ...
        aliases: &[],
        category: "utility",
        description: "Similarity of a node or relationship embedding to a query vector",
        signature: "vector_score(entity :: NODE | RELATIONSHIP, property :: STRING, queryVector :: LIST<FLOAT> [, metric :: STRING] [, options :: MAP]) :: FLOAT?",
    },
    FunctionSpec {
        name: "embedding_norm",
        aliases: &[],
        category: "utility",
        description: "L2 norm of a node or relationship embedding (Poincare depth proxy)",
    ...
    FunctionSpec {
        ...
        aliases: &[],
        category: "utility",
        description: "Similarity of a node or relationship embedding to an embedded query string; requires set_embedder()",
        signature: "text_score(entity :: NODE | RELATIONSHIP, property :: STRING, query :: STRING | LIST<FLOAT> [, metric :: STRING] [, options :: MAP]) :: FLOAT?",
    },
    FunctionSpec {
        name: "randomUUID",
        aliases: &[],
